...
if($propertyId != 0) {
	...
	if(count($array_reports_estimates) > 0)
	{
		...
		{
			$count += 1;
			if(!$array_reports_estimates[$key]['report'] && !$array_reports_estimates[$key]['dailyLogs'])
			{
...
?>
	...
	<div class="pull-right">
		...
		{
			?>
            <a href="add_daily_log.html?propertyId=<?php echo $propertyId; ?>&estimate=true"><button class="btn btn-warning"><i class="icon-plus icon-white"></i> Add Daily Log</button></a>
            <?php	
		}
				...
				foreach($array_reports_estimates as $array_reports_estimate)
				{
					if($array_reports_estimate['dailyLogs'] == 1)
					{
                        ...
                        <div class="report-group">
							  ...
							  ?>
								<div class="report-action"><a href="view_daily_log.html?propertyId=<?php echo $propertyId;?>&id=<?php print $array_reports_estimate["id"]; ?>&estimate=true" class="btn btn-default"><i class="icon-info-sign"></i> View</a></div>
							  <?php 
							  } else if($array_reports_estimate['isSubmitted'] == 0 && $array_reports_estimate['isSaved'] == 1) {
							  ?>
								<div class="report-action"><a href="edit_daily_log.html?propertyId=<?php echo $propertyId;?>&id=<?php echo $array_reports_estimate['id'];?>&estimate=true" class="btn btn-default"><i class="icon-pencil"></i> Edit</a></div>
							  <?php 
							  } 
							  ?>
							  <div class="clearfix"></div>
					...
					else
					{
						...
						?>
							<div class="report-group">
							  <div class="report-thumbnail">&nbsp;</div>
							  <div class="report-details">
									<?php echo date('m/d/Y g:ia', strtotime($array_reports_estimate["dateReported"])); ?> Estimated by <strong><?php echo $array_reports_estimate["firstName"] . " " . $array_reports_estimate["lastName"]; ?></strong> with <strong><?php echo $array_reports_estimate["companyName"];?></strong> - 
									<?php
									if($array_reports_estimate['isSubmitted'] == 1) 
									{
										...
										else if($array_reports_estimate['isClosed'] == 1)
										{
											$estimateStatusName = "Closed";
											$reportStatusClass = "label-default";
										}
										else if($array_reports_estimate['isClosed'] == 2)
										{
											$estimateStatusName = "Archived";
											$reportStatusClass = "label-blue";
										}
										//$estimateStatusName = ($estimate['isClosed']==0?'Open':'Closed');
									?>
							  ...
							  if($array_reports_estimate['isSubmitted'] == 1 && $array_reports_estimate['isSaved'] == 0) {
							  ?>
								<div class="report-action"><a href="view_estimate.html?estimatesId=<?php echo $array_reports_estimate['id'];?>" class="btn btn-default"><i class="icon-info-sign"></i> View</a></div>
							  <?php 
							  } else if($array_reports_estimate['isSubmitted'] == 0 && $array_reports_estimate['isSaved'] == 1) {
							  ?>
				...
				<?php
						...
						else // reports here
						{
							...
							<div class="report-group">
							  ...
							  if($array_reports_estimate['isSubmitted'] == 1 && $array_reports_estimate['isSaved'] == 0) {
							  ?>
								<div class="report-action"><a href="view_report_estimates.html?reportId=<?php echo $array_reports_estimate['id'];?>" class="btn btn-default"><i class="icon-info-sign"></i> View</a></div>
							  <?php 
							  } else if($array_reports_estimate['isSubmitted'] == 0 && $array_reports_estimate['isSaved'] == 1) {
							  ?>
