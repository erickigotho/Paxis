	...
	<div class="navbar">
      <div class="navbar-inner navbar-inverse">
        <div class="container">
          ...
          <a class="brand" href="#">Paxis Pro</a>
			...
			<?php if($isEnableMenu): ?>
			  <div class="nav-collapse collapse">
				<ul class="nav mainnav">
					...
					<?php if(($userRoleId == 1) ||
						     ($userRoleId == 2)): ?>
						<li <?php echo (($pagename=='users' || $pagename=='add_user' || $pagename=='view_user' || $pagename=='assign_properties')?'class="active"':'') ?>><a href="users.html">Users</a></li>
					<?php endif; ?>
					<?php
					if($userRoleId == 5)
					 {
					...
					?>
					<?php if(($userRoleId == 2) || ($userRoleId == 1) ||
							 ($userRoleId == 3) ||
						     ($userRoleId == 4)): 
							 
					?>
						<li <?php echo (($pagename=='properties' || $pagename=='add_property' || $pagename=='edit_property' || $pagename=='add_report' || $pagename=='view_report' || $pagename=="view_property_estimate" || $pagename == "edit_report" || ($pagename == "add_daily_log" && $_REQUEST['estimate'] != 'true') || ($pagename == "view_daily_log" && $_REQUEST['estimate'] != 'true') || ($pagename == "edit_daily_log" && $_REQUEST['estimate'] != 'true'))?'class="active"':'') ?>><a href="properties.html">Properties</a></li>
                        
                        <li <?php echo (($pagename=='estimates' || $pagename=='add_estimate' || $pagename=='edit_estimate' || $pagename=='edit_property_estimate' || $pagename=='view_estimate' || $pagename=='view_report_estimates' || ($pagename == "add_daily_log" && $_REQUEST['estimate'] == 'true') || ($pagename == "view_daily_log" && $_REQUEST['estimate'] == 'true') || ($pagename == "edit_daily_log" && $_REQUEST['estimate'] == 'true'))?'class="active"':'') ?>><a href="estimates.html">Estimates</a></li>
						<li <?php echo (($pagename=='archives' || $pagename=='view_report_archive' || $pagename=='view_daily_log_archive' || $pagename=='edit_archive_property' || $pagename=='view_archive_estimate')?'class="active"':'') ?>><a href="archives.html">Archives</a></li>
                        ...
                        <li <?php echo (($pagename=='complexes' || $pagename=='add_complexes' || $pagename=='edit_complexes')?'class="active"':'') ?>><a href="complexes.html">Complexes</a></li>
					...
					<?php endif; ?>
					<?php if(($userRoleId == 2) || ($userRoleId == 1)): ?>
						<li <?php echo (($pagename=='units' || $pagename=='add_unit' || $pagename=='edit_unit')?'class="active"':'') ?>><a href="units.html">Units</a></li>
