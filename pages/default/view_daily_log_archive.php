...
?>
	...
	<input type="hidden" id="userId" name="userId" value="<?php echo $_SESSION['user_id']; ?>" />
		...
		<div class="pull-left"><h4>View Daily Log Archive</h4></div>
		<div class="pull-right"><a href="edit_archive_property.html?propertyId=<?php print $_REQUEST['propertyId'];  ?>" class="btn btn-default">Cancel</a></div>
