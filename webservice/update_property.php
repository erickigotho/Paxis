...
$propertyObj->updatePropertyInfo($id, $name, $address, $city, $zip, $link, $estimatesMultiplier, $status, $userId, $emails, $propertyType, $jobType, $estimatesEmailList, $community);
?>